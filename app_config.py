...
from utils.broker import AlpacaClient, Broker
from utils.notification import Pushover, Notification
...
class AppConfig(object):
    ...
    def bootstrap_di(self) -> None:
        ...
        di[Notification] = self.notification
        di[WatchList] = self.watchlist
        di[Broker] = self.broker
